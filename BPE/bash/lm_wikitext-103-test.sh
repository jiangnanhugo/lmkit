#!/bin/sh
THEANO_FLAGS='floatX=float32,device=cuda3,optimizer=fast_run'    python main.py  --valid_file ../data/wikitext-103/idx_wiki.valid.tokens \
            --test_file ../data/wikitext-103/idx_wiki.test.tokens \
            --model_dir ./model/parameters_101836.61.pkl \
            --vocab_size 267736 \
            --batch_size 1  \
            --mode testing
## 58915.87
